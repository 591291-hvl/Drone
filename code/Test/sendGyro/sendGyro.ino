...
void send() {
    ...
    Serial.print("x angle: " + String(dataToSend[0]) + " ");
    Serial.print("y angle: " + String(dataToSend[1]) + " ");
    Serial.print("XL: " + String(dataToSend[2]) + " ");
    if (rslt) {
...
void updateMessage() {
    ...
    dataToSend[0] = Total_angle_x;
    dataToSend[1] = Total_angle_y;
    dataToSend[2] = mapXL;
}
